...
if (isset($_POST['title'])){
    ...
    $stmt=$mysqli->prepare("INSERT INTO posts title='$title', content='$content', uid='$uid', postDate=''");
...
if ($_SESSION['level'] > 2){
    ...
    $mysqli = new mysqli(DB_SERVER, DB_USERNAME, DB_PASSWORD, DB_DATABASE);
    $stmt=$mysqli->prepare("SELECT title, content, uid, postDate FROM posts WHERE uid='$uid' ORDER BY postDate DESC");
